...
import {routeGuard} from "./module/shared/guard/route.guard";



const routes: Routes = [
  {path:'',redirectTo:'starter/home',pathMatch:'full'},
  { path: 'console', loadChildren: () => import('./module/console/console.module').then(m => m.ConsoleModule),canActivate:[routeGuard] },
